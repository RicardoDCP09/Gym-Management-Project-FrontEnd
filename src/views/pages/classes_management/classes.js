...
import { cilClock, cilBadge, cilGroup, cilCheckAlt, cilTag, cilColorBorder } from '@coreui/icons'
import {
  CCard,
  CButton,
  CCardBody,
...
const Classes = () => {
  ...
  const handleEditClass = async () => {
    ...
    try {
      const updatedClass = await API.put('classes', currentClass, currentClass.id)
      setClasses((prevClass) =>
        prevClass.map((class_) =>
          class_.id === currentClass.id ? { ...class_, ...updatedClass } : class_,
        ),
      )
                ...
                <CRow className="mb-3">
                  ...
                  <CCol md={6}>
                    ...
                    >
                      ...
                      {traineer
                        .filter((trainer) => trainer.role === 2)
                        .map((trainer) => (
                          <option key={trainer.id_user} value={trainer.id_user}>
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentClass({ ...currentClass, coach_id: e.target.value })
                            }
                          >
                            <option value="">Select a Trainer</option>
                            {traineer
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentClass({ ...currentClass, amount: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={6} className="mb-3">
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentClass({ ...currentClass, status: e.target.value })
                            }
                          >
                            <option value="">Select a Status </option>
                            {statusClass.map((status) => (
                        ...
                        <CCol md={12} className="mb-3">
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentClass({ ...currentClass, class_time: e.target.value })
                            }
                          />
                        </CCol>
                      </CRow>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditClass}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
