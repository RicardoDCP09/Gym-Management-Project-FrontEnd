...
import { cilColorBorder, cilWeightlifitng, cilDescription, cilChart } from '@coreui/icons'
import {
  CCard,
  CButton,
  CCardBody,
              ...
              <CModalBody>
                ...
                <CCol md={12}>
                  ...
                  >
                    ...
                    {statusex.map((status) => (
                      <option key={status.id_texercises} value={status.id_texercises}>
                        {status.name}
                      </option>
                    ))}
                  </CFormSelect>
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol md={12}>
                          ...
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentExercise({ ...currentExercise, type: e.target.value })
                            }
                          >
                            <option value="">Select a type</option>
                            {statusex.map((statusex) => (
                              <option key={statusex.id_texercises} value={statusex.id_texercises}>
                                {statusex.name}
                              </option>
                            ))}
                          </CFormSelect>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditExercise}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteExercise}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
