...
import { cilClock, cilInbox, cilCheckAlt, cilTag, cilColorBorder } from '@coreui/icons'
import {
  CCard,
  CButton,
  CCardBody,
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentInventory({ ...currentInventory, status: e.target.value })
                            }
                          >
                            <option value="">Select a Status</option>
                            {statuses.map((status) => (
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormInput
                            ...
                            placeholder="Date Use"
                            value={
                              currentInventory?.day_use
                                ? currentInventory.day_use.split('T')[0]
                                : '' || ''
                            }
                            onChange={(e) =>
                              setNewItem({ ...currentInventory, day_use: e.target.value })
                            }
                          />
                        </CCol>
                      </CRow>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditInventory}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalBody>
                      <CRow className="mb-3">
                        <label className="fw-bold mb-2">
                          Please write "confirm" if you want to delete this Item
                        </label>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteInventory}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
