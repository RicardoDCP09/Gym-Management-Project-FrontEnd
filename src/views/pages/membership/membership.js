...
import { cilClock, cilTag, cilColorBorder, cilCash } from '@coreui/icons'
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        <CCol className="mb-3" md={6}>
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentMembership({ ...currentMembership, name: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol className="mb-3" md={6}>
                      ...
                      <CRow className="mb-3">
                        <CCol className="mb-3" md={6}>
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentMembership({ ...currentMembership, price: e.target.value })
                            }
                          />
                        </CCol>
                      </CRow>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditMembership}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteMembership}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
