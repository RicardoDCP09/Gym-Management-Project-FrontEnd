...
const Payment = () => {
  ...
  const handleEditPay = async () => {
    ...
    try {
      const updatedPay = await API.put('payments', currentPay, currentPay.id_payment)
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentPay({ ...currentPay, amount: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={6} className="mb-3">
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentPay({ ...currentPay, status: e.target.value })
                            }
                          >
                            <option value="">Select a Payment Method </option>
                            {statusPayment.map((status) => (
                        ...
                        <CCol md={6} className="mb-3">
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentPay({ ...currentPay, payment_method: e.target.value })
                            }
                          >
                            <option value="">Select a Payment Method </option>
                            {methodPay.map((method) => (
                        ...
                        <CCol md={12} className="mb-3">
                          <CFormInput
                            ...
                            value={
                              currentPay?.daypayment
                                ? currentPay.daypayment.split('T')[0]
                                : '' || ''
                            }
                            onChange={(e) =>
                              setCurrentPay({ ...currentPay, daypayment: e.target.value })
                            }
                          />
                        </CCol>
                      </CRow>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditPay}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeletePay}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
