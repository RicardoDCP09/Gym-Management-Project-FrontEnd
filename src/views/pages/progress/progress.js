  ...
  const handleDeleteProgress = async () => {
    if (deleteConfirmation === 'confirm') {
      ...
      try {
        ...
        setFilteredProgress((prevFiltered) =>
          prevFiltered.filter((progress_) => progress_.id_progress !== progressId),
        )
        ...
        >
          <CRow className="g-3">
            ...
            <CCol className="d-flex justify-content-start">
              <CButton className="me-2" color="primary" onClick={() => setVisible(!visible)}>
                Add Progress
              </CButton>
            </CCol>
            <CModal
                ...
                <CRow className="mb-3">
                  <CCol md={4}>
                    ...
                    <CFormInput
                      ...
                      onChange={(e) =>
                        setNewProgress({ ...newProgress, musclegain: e.target.value })
                      }
                    />
                  </CCol>
                  <CCol md={4}>
                    ...
                    <CFormInput
                      ...
                      onChange={(e) =>
                        setNewProgress({ ...newProgress, benchpress: e.target.value })
                      }
                    />
                  </CCol>
                  <CCol md={4}>
        ...
        <CTable hover responsive striped>
          <CTableHead>
            <CTableRow>
              ...
              <CTableHeaderCell>Body Fat</CTableHeaderCell>
              <CTableHeaderCell>Muscle Gain</CTableHeaderCell>
              <CTableHeaderCell>Bench Press</CTableHeaderCell>
              <CTableHeaderCell>Squats</CTableHeaderCell>
              <CTableHeaderCell>Dead Lift</CTableHeaderCell>
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            type="date"
                            value={
                              currentProgress?.date ? currentProgress.date.split('T')[0] : '' || ''
                            }
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, date: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, weight: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, bodyfat: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, musclegain: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, benchpress: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={4} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, squats: e.target.value })
                            }
                          />
                        </CCol>
                        <CCol md={12} className="mb-3">
                          ...
                          <CFormInput
                            ...
                            onChange={(e) =>
                              setCurrentProgress({ ...currentProgress, deadlift: e.target.value })
                            }
                          />
                        </CCol>
                      </CRow>
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditProgress}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteProgress}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
