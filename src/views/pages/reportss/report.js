...
const report = () => {
  ...
  const handleEditReport = async () => {
    ...
    try {
      const updateReport = await API.put('reports', currentReport, currentReport.id_report)
      setReport((prevReport) =>
        prevReport.map((report) =>
          report.id_report === currentReport.id_report ? { ...report, ...updateReport } : report,
        ),
      )
                ...
                <CTableDataCell>
                  ...
                  >
                      ...
                      <CRow className="mb-3">
                        <CCol md={12} className="mb-3">
                          ...
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentReport({ ...currentReport, type: e.target.value })
                            }
                          >
                            <option value="">Select a Type</option>
                            {reportType.map((report) => (
                        ...
                        <CCol md={12} className="mb-3">
                          ...
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentReport({ ...currentReport, user_id: e.target.value })
                            }
                          >
                            <option value="">Select a User</option>
                            {users.map((user) => (
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleEditReport}>
                        Save Edit
                      </CButton>
                    </CModalFooter>
                  </CModal>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteReport}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
