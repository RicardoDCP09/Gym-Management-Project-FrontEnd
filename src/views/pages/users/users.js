    ...
    try {
      ...
      setUsers((prevUsers) =>
        prevUsers.map((Member) =>
          Member.id_user === currentUser.id_user ? { ...Member, ...updatedUser } : Member,
        ),
      )
                ...
                <CTableDataCell>
                      ...
                      <CRow>
                        <CCol className="mb-3" md={6}>
                          <CFormInput
                            ...
                            placeholder="date of birth"
                            value={
                              currentUser?.fechanac ? currentUser.fechanac.split('T')[0] : '' || ''
                            }
                            onChange={(e) =>
                              setCurrentUser({ ...currentUser, fechanac: e.target.value })
                            }
                          />
                          <small className="text-muted">Please select the date of birth.</small>
                        </CCol>
                          ...
                          <CFormInput
                            ...
                            value={
                              currentUser?.registerdate
                                ? currentUser.registerdate.split('T')[0]
                                : '' || ''
                            }
                            onChange={(e) =>
                      ...
                      <CRow>
                        <CCol md={6}>
                          <CFormSelect
                            ...
                            onChange={(e) =>
                              setCurrentUser({ ...currentUser, typemembership: e.target.value })
                            }
                          >
                            {' '}
                            <option value="">Select Type Membership</option>
                  ...
                  >
                    ...
                    <CModalFooter>
                      ...
                      <CButton color="primary" onClick={handleDeleteUser}>
                        Delete
                      </CButton>
                    </CModalFooter>
                  </CModal>
